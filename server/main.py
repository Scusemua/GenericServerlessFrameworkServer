...
from cyclicbarrier import CyclicBarrier
...
barrier.wait_b()
# give time for all threads to print last message
time.sleep(3)

#
# Execute: python main.py
# main makes two threads to call Barrier.waitB. Here we are
# doing everything locally, i.e., not using Pyro remote objects.
